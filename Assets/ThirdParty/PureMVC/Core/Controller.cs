...
namespace PureMVC.Core
{
    ...
    public class Controller: IController
    {
        ...
        {
            Func<ICommand> commandFuncTemp;
            if (commandMap.TryGetValue(notificationName, out commandFuncTemp) == false)
            {
        ...
        {
            Func<ICommand> commandFuncTemp;
            if (commandMap.TryGetValue(notificationName, out commandFuncTemp))
            {
